...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self) -> pd.DataFrame:
        """
        Fetch data from MongoDB collection and convert to DataFrame.
        """
        try:
            ...
            logging.info(f"Data fetched from DB. Shape: {df.shape}")
    ...
    def export_data_into_feature_store(self, dataframe: pd.DataFrame) -> pd.DataFrame:
        """
        Save raw data to feature store (CSV).
        """
        try:
    ...
    def split_data_as_train_test(self, dataframe: pd.DataFrame):
        """
        Split the dataset into train and test CSV files.
        """
        try:
            #  Check before splitting
            if dataframe.shape[0] < 2:
                raise Exception("Not enough data to perform train-test split.")
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        ...
        try:
            ...
            #  Step 2: Save raw/feature-store data
